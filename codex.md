...
This project is Routstr's frontend chat application built with React 18.x, nextJs, and Nostrify.
...
This comes with custom hooks for querying and publishing events on the Nostr network.
